...
import one.d4d.signsaboteur.rsta.token.SignedTokenMaker;
import one.d4d.signsaboteur.rsta.token.SignedTokenizerConstants;
import one.d4d.signsaboteur.utils.FontProvider;
...
import static one.d4d.signsaboteur.rsta.CustomTokenColors.customTokenColors;
import static one.d4d.signsaboteur.rsta.token.SignedTokenMaker.*;
import static one.d4d.signsaboteur.rsta.token.SignedTokenizerConstants.MAPPING;
import static one.d4d.signsaboteur.rsta.token.SignedTokenizerConstants.TOKEN_MAKER_FQCN;
